...
rust_library(
    ...
    srcs = glob(["**/*.rs"]),
    deps = [
        "@complicated__aho_corasick__0_6_4//:aho_corasick",
        "@complicated__memchr__2_0_1//:memchr",
        "@complicated__regex_syntax__0_4_2//:regex_syntax",
        "@complicated__thread_local__0_3_5//:thread_local",
        "@complicated__utf8_ranges__1_0_0//:utf8_ranges",
